...
$sql3="SELECT status,count(status) as counter From bhavyesh_four__oman_oredo_pin_verify where DATE(date) between '$from' and '$to' group by status";
...
<br>
<?php
 $sql1="SELECT * From bhavyesh_four__oman_oredo_pin_verify where DATE(date) between '$from' and '$to' order by date desc";
//exit();
//exit();
