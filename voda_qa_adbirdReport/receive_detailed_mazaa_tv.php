<head>
  <title>voda_qa_adbirdReport Report PROMOTIONS </title>
  <meta charset="utf-8">
...
$sql3="SELECT status,count(status) as counter From qatar_voda_adbird_pin_verify where DATE(date) between '$from' and '$to' group by status";
...
<br>
<?php
 $sql1="SELECT * From qatar_voda_adbird_pin_verify where DATE(date) between '$from' and '$to' order by date desc";
//exit();
//exit();
