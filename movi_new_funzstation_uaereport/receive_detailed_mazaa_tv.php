...
$sql3="SELECT status,count(status) as counter From movi_ex_new_funzstation_uae_alt_pin_verify where DATE(date_india) between '$from' and '$to' group by status";
...
<br>
<?php
 $sql1="SELECT * From movi_ex_new_funzstation_uae_alt_pin_verify where DATE(date_india) between '$from' and '$to' order by id desc";
//exit();
//exit();
