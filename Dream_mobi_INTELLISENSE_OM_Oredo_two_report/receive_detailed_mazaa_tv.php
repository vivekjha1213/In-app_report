<head>
  <title>Dream_mobi_OMANTALINTELLISENSE_OOREEDOO_TWO</title>
  <meta charset="utf-8">
...
$sql3="SELECT status,count(status) as counter From in_app_pin_verify where DATE(date) between '$from' and '$to' and pubName='DREAM_MOBI' and serviceName='INTELLISENSE_OOREEDOO_TWO' group by status";
...
<br>
<?php
 $sql1="SELECT * From in_app_pin_verify where DATE(date) between '$from' and '$to' and pubName='DREAM_MOBI' and serviceName='INTELLISENSE_OOREEDOO_TWO' order by date desc";
//exit();
//exit();
