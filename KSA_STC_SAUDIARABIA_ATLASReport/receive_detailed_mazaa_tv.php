<head>
  <title>KSA_STC_SAUDIARABIA_ATLASReport Report PROMOTIONS </title>
  <meta charset="utf-8">
...
$sql3="SELECT status,count(status) as counter From atlas_saudi_arabia_timwe_stc_pin_verify where DATE(date) between '$from' and '$to' group by status";
...
<br>
<?php
 $sql1="SELECT * From atlas_saudi_arabia_timwe_stc_pin_verify where DATE(date) between '$from' and '$to' order by date desc";
//exit();
//exit();
