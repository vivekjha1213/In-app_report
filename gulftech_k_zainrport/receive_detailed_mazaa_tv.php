...
$sql3="SELECT status,count(status) as counter From gulftech_southmix_kw_zain_comviva_pin_verify where DATE(date) between '$from' and '$to' group by status";
...
<br>
<?php
 $sql1="SELECT * From gulftech_southmix_kw_zain_comviva_pin_verify where DATE(date) between '$from' and '$to' order by date desc";
//exit();
//exit();
