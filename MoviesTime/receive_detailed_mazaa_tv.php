...
$sql3="SELECT status,count(status) as counter Movies_time_oman_oreedoo_verify where DATE(date) between '$from' and '$to' group by status";
...
<br>
<?php
 $sql1="SELECT * Movies_time_oman_oreedoo_verify where DATE(date) between '$from' and '$to' order by date desc";
//exit();
//exit();
