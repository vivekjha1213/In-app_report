<head>
  <title>ATLAS_Shemaroo_Kuwait_stc  PROMOTIONS </title>
  <meta charset="utf-8">
...
$sql3="SELECT status,count(status) as counter From ATLAS_Shemaroo_Kuwait_stc_pin_verify where DATE(date) between '$from' and '$to' group by status";
...
<br>
<?php
 $sql1="SELECT * From ATLAS_Shemaroo_Kuwait_stc_pin_verify where DATE(date) between '$from' and '$to' order by date desc";
//exit();
//exit();
