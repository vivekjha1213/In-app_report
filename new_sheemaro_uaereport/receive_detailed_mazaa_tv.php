<head>
  <title>new_Shemaroo_UAE_Etisalat_ PROMOTIONS </title>
  <meta charset="utf-8">
...
$sql3="SELECT status,count(status) as counter From new_Shemaroo_UAE_Etisalat_pin_verify where DATE(date) between '$from' and '$to' group by status";
...
<br>
<?php
 $sql1="SELECT * From new_Shemaroo_UAE_Etisalat_pin_verify where DATE(date) between '$from' and '$to' order by date desc";
//exit();
//exit();
