...
$sql3="SELECT status,count(status) as counter From MOVI_TIMES_INTELLISENSE_OM_OOREDOO where DATE(date) between '$from' and '$to' group by status";
...
<br>
<?php
 $sql1="SELECT * From MOVI_TIMES_INTELLISENSE_OM_OOREDOO where DATE(date) between '$from' and '$to' order by date desc";
//exit();
//exit();
