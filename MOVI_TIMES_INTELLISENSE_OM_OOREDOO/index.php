...
<head>
  ...
  <title>MOVI_TIMES_INTELLISENSE_OM_OOREDOO</title>
  <meta charset="utf-8">
...
<body>
<div class="container">
  <h2>REPORT(MOVI_TIMES_INTELLISENSE_OM_OOREDOO conversion tracker)</h2>
  <p>MOVI_TIMES_INTELLISENSE_OM_OOREDOO</p>
   <div class="text-right">
      ...
      <div class="black_box">
<a class="gold_text" href="http://beyondhealth.info/INAPP_API_REPORT/MOVI_TIMES_INTELLISENSE_OM_OOREDOO?date=<?=date("Y-m-d")?>">Refresh</a>
</div>
...
<div id="today_report">
<?php
$sql3="SELECT status,count(status) as counter From MOVI_TIMES_INTELLISENSE_OM_OOREDOO where DATE(date) between '$today_date' and '$today_date' group by status";
...
<?php
    ...
    $sql="SELECT  count(distinct msisdn) as counter  FROM `MOVI_TIMES_INTELLISENSE_OM_OOREDOO`  where DATE(date) between '$today_date' and '$today_date'";
    $sql2="SELECT  count(distinct msisdn) as counter  FROM MOVI_TIMES_INTELLISENSE_OM_OOREDOO  where `status` IN ('PASSED', 'BLOCK') AND DATE(date) between '$today_date' and '$today_date'";
...
<br>
<?php
$sql1="SELECT * From MOVI_TIMES_INTELLISENSE_OM_OOREDOO where date(date) between '$today_date' and '$today_date' order by id desc";
//exit();
//exit();
