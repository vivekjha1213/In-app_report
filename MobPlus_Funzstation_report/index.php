...
<head>
  ...
  <title>MobPlus_Funzstation_report </title>
  <meta charset="utf-8">
...
<body>
<div class="container">
  <h2>REPORT(MobPlus_Funzstation_report conversion tracker)</h2>
  <p>MobPlus_Funzstation_report</p>
...
<div id="today_report">
<?php   
$sql3="SELECT status,count(status) as counter From in_app_pin_verify where DATE(date) between '$today_date' and '$today_date' and serviceId='ARSH0046' group by status";
...
<?php
    ...
    $sql="SELECT  count(distinct msisdn) as counter  FROM `in_app_pin_verify`  where DATE(date) between '$today_date' and '$today_date' and serviceId='ARSH0046'";
    $sql2="SELECT  count(distinct msisdn) as counter  FROM in_app_pin_verify  where `status` IN ('PASSED', 'BLOCK') AND DATE(date) between '$today_date' and '$today_date' and serviceId='ARSH0046'";
...
<br>
<?php
$sql1="SELECT * From in_app_pin_verify where date(date) between '$today_date' and '$today_date' and serviceId='ARSH0046' order by id desc";
//exit();
//exit();
