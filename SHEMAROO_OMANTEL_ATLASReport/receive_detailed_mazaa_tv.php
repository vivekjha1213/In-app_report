...
$sql3="SELECT status,count(status) as counter From atlas_she_omantel_verify where DATE(date) between '$from' and '$to' and cid='ATLAS' group by status";
...
<br>
<?php
 $sql1="SELECT * From atlas_she_omantel_verify where DATE(date) between '$from' and '$to' and cid='ATLAS' order by date desc";
//exit();
//exit();
