...
<body>
<div class="container">
  <h2>REPORT( fight_club conversion tracker)</h2>
  <p>Promotions Details of  fight_club.</p>
...
<div id="today_report">
<?php
$sql3="SELECT status,count(status) as counter From fight_club_verify where DATE(date) between '$today_date' and '$today_date' group by status";
...
<?php
    ...
    $sql="SELECT  count(distinct msisdn) as counter  FROM `fight_club_verify`  where DATE(date) between '$today_date' and '$today_date'";
    $sql2="SELECT  count(distinct msisdn) as counter  FROM fight_club_verify  where `status` IN ('PASSED', 'BLOCK') AND DATE(date) between '$today_date' and '$today_date'";
...
<br>
<?php
$sql1="SELECT * From fight_club_verify where date(date) between '$today_date' and '$today_date' order by id desc";
//exit();
//exit();
