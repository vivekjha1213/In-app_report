...
$sql3="SELECT status,count(status) as counter ENTERTAINMENT_GALAXY_Pin_Verify where DATE(date) between '$from' and '$to' group by status";
...
<br>
<?php
 $sql1="SELECT * ENTERTAINMENT_GALAXY_Pin_Verify where DATE(date) between '$from' and '$to' order by date desc";
//exit();
//exit();
