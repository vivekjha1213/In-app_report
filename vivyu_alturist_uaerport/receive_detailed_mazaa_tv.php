...
$sql3="SELECT status,count(status) as counter From vivyu_altruist_uae__pin_verify where DATE(date) between '$from' and '$to' group by status";
...
<br>
<?php
 $sql1="SELECT * From vivyu_altruist_uae__pin_verify where DATE(date) between '$from' and '$to' order by date desc";
//exit();
//exit();
