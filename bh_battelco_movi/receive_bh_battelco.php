<head>
  <title>movi plus BAHRAIN Battelco PROMOTIONS</title>
  <meta charset="utf-8">
...
<div class="container h-100">
    <div class="row h-100 justify-content-center align-items-center">
        <div class="col-10 col-md-8 col-lg-6">
          <!---FOR FORM CENTER----------->
          <form method="post" action="receive_detailed_bh_battelco.php" >
...
<br>
<?php
$sql3="SELECT result,count(result) as counter From movi_bh_timwe_batelco_optin_verify where DATE(date_bahrain) between '$from' and '$modified_to'  group by result";
...
<?php 
 ...
 <!-- //CODE FOR CR -->
    <?php
    $sql="SELECT  count(distinct msisdn) as counter  FROM `movi_bh_timwe_batelco_optin_verify`  where DATE(date_bahrain) between '$from' and '$modified_to'";
    $sql2="SELECT  count(distinct msisdn) as counter  FROM movi_bh_timwe_batelco_optin_verify  where `result` IN ('SUBSCRIBE PASSED', 'SUBSCRIBE BLOCKED') AND DATE(date_bahrain) between '$from' and '$modified_to'";
...
<br>
<?php
$sql1="SELECT * From movi_bh_timwe_batelco_optin_verify where DATE(date_bahrain) between '$from' and '$modified_to'";
//exit();
//exit();
