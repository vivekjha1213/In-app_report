<head>
  <title>FUNZSTATION_UAE_IGK Report PROMOTIONS </title>
  <meta charset="utf-8">
...
$sql3="SELECT status,count(status) as counter From gamespad_promotion where DATE(date) between '$from' and '$to' and cid='igknight' group by status";
...
<br>
<?php
 $sql1="SELECT * From gamespad_promotion where DATE(date) between '$from' and '$to' and cid='igknight' order by date desc";
//exit();
//exit();
