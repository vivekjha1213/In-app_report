...
$sql3="SELECT status,count(status) as counter From movi_ex_new_beyondhealth_olimob_promotion where DATE(date) between '$from' and '$to' group by status";
...
<br>
<?php
 $sql1="SELECT * From movi_ex_new_beyondhealth_olimob_promotion where DATE(date) between '$from' and '$to' order by date desc";
//exit();
//exit();
