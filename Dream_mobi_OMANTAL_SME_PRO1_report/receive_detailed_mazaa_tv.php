...
$sql3="SELECT status,count(status) as counter From in_app_pin_verify where DATE(date) between '$from' and '$to' and pubName='DREAM_MOBI' and serviceName='SHEMAROO_OMANTEL_SME' group by status";
...
<br>
<?php
 $sql1="SELECT * From in_app_pin_verify where DATE(date) between '$from' and '$to' and pubName='DREAM_MOBI' and serviceName='SHEMAROO_OMANTEL_SME' order by date desc";
//exit();
//exit();
