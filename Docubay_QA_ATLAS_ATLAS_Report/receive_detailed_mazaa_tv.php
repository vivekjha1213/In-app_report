<head>
  <title>Docubay_QA_ATLAS_ATLAS_Report Report PROMOTIONS </title>
  <meta charset="utf-8">
...
$sql3="SELECT status,count(status) as counter From atlas_qatar_oredo_etisalat_pin_verify where DATE(date) between '$from' and '$to' group by status";
...
<br>
<?php
 $sql1="SELECT * From atlas_qatar_oredo_etisalat_pin_verify where DATE(date) between '$from' and '$to' order by date desc";
//exit();
//exit();
