...
<head>
  ...
  <title>Fight Mania uAE Etisalat </title>
  <meta charset="utf-8">
...
<body>
<div class="container">
  <h2>REPORT(Fight Mania UAE Etisalat conversion tracker)</h2>
  <p>Fight Mania UAE Etisalat</p>
   <div class="text-right">
      ...
      <div class="black_box">
<a class="gold_text" href="http://beyondhealth.info/INAPP_API_REPORT/Fight_Mania_AE_Etisalat_report?date=<?=date("Y-m-d")?>">Refresh</a>
</div>
...
<div id="today_report">
<?php
$sql3="SELECT status,count(status) as counter From in_app_pin_verify where DATE(date) between '$today_date' and '$today_date' and pubName='OLIMOB' and serviceName='Fight Mania' group by status";
...
<?php
    ...
    $sql="SELECT  count(distinct msisdn) as counter  FROM `in_app_pin_verify`  where DATE(date) between '$today_date' and '$today_date' and pubName='OLIMOB' and serviceName='Fight Mania'";
    $sql2="SELECT  count(distinct msisdn) as counter  FROM in_app_pin_verify  where `status` IN ('PASSED', 'BLOCK') AND DATE(date) between '$today_date' and '$today_date' and pubName='OLIMOB' and serviceName='Fight Mania'";
...
<br>
<?php
$sql1="SELECT * From in_app_pin_verify where date(date) between '$today_date' and '$today_date' and pubName='OLIMOB' and serviceName='Fight Mania' order by id desc";
//exit();
//exit();
