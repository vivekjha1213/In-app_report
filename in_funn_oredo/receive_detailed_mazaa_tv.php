...
$sql3="SELECT status,count(status) as counter From ooreedo_funzstation_tpay_plt_pin_verify where DATE(date) between '$from' and '$to' group by status";
...
<br>
<?php
 $sql1="SELECT * From ooreedo_funzstation_tpay_plt_pin_verify where DATE(date) between '$from' and '$to' order by date desc";
//exit();
//exit();
