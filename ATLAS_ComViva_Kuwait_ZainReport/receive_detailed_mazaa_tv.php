<head>
  <title>ATLAS ComViva_Kuwait_Zain Report PROMOTIONS </title>
  <meta charset="utf-8">
...
$sql3="SELECT status,count(status) as counter From atlas_southmix_kw_zain_comviva_pin_verify where DATE(date) between '$from' and '$to' group by status";
...
<br>
<?php
 $sql1="SELECT * From atlas_southmix_kw_zain_comviva_pin_verify where DATE(date) between '$from' and '$to' order by date desc";
//exit();
//exit();
