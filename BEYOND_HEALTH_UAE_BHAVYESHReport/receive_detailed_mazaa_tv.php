...
$sql3="SELECT response,count(response) as counter From bhavyesh_tpay_uae_pin_verify where DATE(date) between '$from' and '$to' group by response";
...
<br>
<?php
 $sql1="SELECT * From bhavyesh_tpay_uae_pin_verify where DATE(date) between '$from' and '$to' order by date desc";
//exit();
//exit();
