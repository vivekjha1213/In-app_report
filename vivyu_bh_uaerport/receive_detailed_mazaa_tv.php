<head>
  <title>vivyu_beyondhealth_olimob PROMOTIONS </title>
  <meta charset="utf-8">
...
$sql3="SELECT status,count(status) as counter From vivyu_beyondhealth_olimob_promotion where DATE(date) between '$from' and '$to' group by status";
...
<br>
<?php
 $sql1="SELECT * From vivyu_beyondhealth_olimob_promotion where DATE(date) between '$from' and '$to' order by date desc";
//exit();
//exit();
