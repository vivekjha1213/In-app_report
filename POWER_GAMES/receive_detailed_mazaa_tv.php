...
$sql3="SELECT status,count(status) as counter Powergane_Uae_bhayes_pin_verify where DATE(date) between '$from' and '$to' group by status";
...
<br>
<?php
 $sql1="SELECT * Powergane_Uae_bhayes_pin_verify where DATE(date) between '$from' and '$to' order by date desc";
//exit();
//exit();
