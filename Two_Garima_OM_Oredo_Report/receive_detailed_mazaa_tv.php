...
$sql3="SELECT status,count(status) as counter From TWO_garima_om_omantel_pin_verify where DATE(date) between '$from' and '$to' group by status";
...
<br>
<?php
 $sql1="SELECT * From TWO_garima_om_omantel_pin_verify where DATE(date) between '$from' and '$to' order by date desc";
//exit();
//exit();
