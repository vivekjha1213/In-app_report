<head>
  <title>new_game2play_uae_etisalat_pin_verify PROMOTIONS </title>
  <meta charset="utf-8">
...
$sql3="SELECT status,count(status) as counter From new_game2play_uae_etisalat_pin_verify where DATE(date) between '$from' and '$to' group by status";
...
<br>
<?php
 $sql1="SELECT * From new_game2play_uae_etisalat_pin_verify where DATE(date) between '$from' and '$to' order by date desc";
//exit();
//exit();
