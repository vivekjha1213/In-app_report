...
<body>
<div class="container">
  <h2>REPORT(BEYOND-LIFESTYLE ZA conversion tracker)</h2>
  <p>Promotions Details of ZA MTN.</p>
   <div class="text-right">

        <a href="http://beyondhealth.info/INAPP/za_mtn.php" class="btn btn-info btn-lg">
