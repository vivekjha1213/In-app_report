...
$sql3="SELECT status,count(status) as counter From atlas_epicon_qatar_pin_verify where DATE(date_india) between '$from' and '$to' group by status";
...
<br>
<?php
 $sql1="SELECT * From atlas_epicon_qatar_pin_verify where DATE(date_india) between '$from' and '$to' order by date desc";
//exit();
//exit();
