...
$sql3="SELECT status,count(status) as counter Globocom_she_omantel_verify where DATE(date) between '$from' and '$to' group by status";
...
<br>
<?php
 $sql1="SELECT * Globocom_she_omantel_verify where DATE(date) between '$from' and '$to' order by date desc";
//exit();
//exit();
