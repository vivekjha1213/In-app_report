<head>
  <title>MCAFE_OMANTEL_ART_REPORT Report PROMOTIONS </title>
  <meta charset="utf-8">
...
$sql3="SELECT status,count(status) as counter From art_promotiona_omatel_timwe_verify where DATE(date) between '$from' and '$to' group by status";
...
<br>
<?php
 $sql1="SELECT * From art_promotiona_omatel_timwe_verify where DATE(date) between '$from' and '$to' order by date desc";
//exit();
//exit();
