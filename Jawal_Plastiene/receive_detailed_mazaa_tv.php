...
$sql3="SELECT status,count(status) as counter jw_pl_gaurva_suri_pin_verify where DATE(date) between '$from' and '$to' group by status";
...
<br>
<?php
 $sql1="SELECT * jw_pl_gaurva_suri_pin_verify where DATE(date) between '$from' and '$to' order by date desc";
//exit();
//exit();
