<head>
  <title>QATAR OOREDOO _IBU_pin_verify PROMOTIONS </title>
  <meta charset="utf-8">
...
$sql3="SELECT status,count(status) as counter From Oman_ooredo_IBU_pin_verify where DATE(date) between '$from' and '$to' group by status";
...
<br>
<?php
 $sql1="SELECT * From Oman_ooredo_IBU_pin_verify where DATE(date) between '$from' and '$to' order by date desc";
//exit();
//exit();
