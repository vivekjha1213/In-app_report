...
$sql3="SELECT status,count(status) as counter From two_Oman_Omantel_Intellisense_pin_verify where DATE(date) between '$from' and '$to' group by status";
...
<br>
<?php
 $sql1="SELECT * From two_Oman_Omantel_Intellisense_pin_verify where DATE(date) between '$from' and '$to' order by date desc";
//exit();
//exit();
