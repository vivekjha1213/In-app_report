<head>
  <title>SHEMAROO_QA_MOBILEARTReport   PROMOTIONS</title>
  <meta charset="utf-8">
...
<br>
<?php
$sql3="SELECT status,count(status) as counter From mobiart_epicon_qatar_pin_verify where DATE(date_india) between '$from' and '$modified_to' group by status";
//exit();
...
<?php
    ...
    <!-- //CODE FOR CR -->
    <?php
    $sql="SELECT  count(distinct msisdn) as counter  FROM `mobiart_epicon_qatar_pin_verify`  where DATE(date_india) between '$from' and '$modified_to'";
    $sql2="SELECT  count(distinct msisdn) as counter  FROM mobiart_epicon_qatar_pin_verify  where `status` IN ('PASSED', 'BLOCK') AND DATE(date_india) between '$from' and '$modified_to'";
...
<br>
<?php
$sql1="SELECT * From mobiart_epicon_qatar_pin_verify where DATE(date_india) between '$from' and '$modified_to' order by id desc";
//exit();
//exit();
