...
<head>
  ...
  <title>ONE97_OMAN_OMANTEL </title>
  <meta charset="utf-8">
...
<body>
<div class="container">
  <h2>REPORT(ONE97_OMAN_OMANTEL conversion tracker)</h2>
  <p>ONE97_OMAN_OMANTEL</p>
   <div class="text-right">
      ...
      <div class="black_box">
<a class="gold_text" href="http://beyondhealth.info/INAPP_API_REPORT/ONE97_OMAN_OMANTEL_REPORT?date=<?=date("Y-m-d")?>">Refresh</a>
</div>
