<head>
  <title>SHEMAROO_OMANTEL_OLIMOB2 Report PROMOTIONS </title>
  <meta charset="utf-8">
...
$sql3="SELECT status,count(status) as counter From she_omantel_verify where DATE(date) between '$from' and '$to' and cid='OLIMOB2' group by status";
...
<br>
<?php
 $sql1="SELECT * From she_omantel_verify where DATE(date) between '$from' and '$to' and cid='OLIMOB2' order by date desc";
//exit();
//exit();
