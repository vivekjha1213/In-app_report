<head>
  <title>ENMNT_SHEMAROO_OMANTEL_OLIMOB2Report   PROMOTIONS</title>
  <meta charset="utf-8">
...
<br>
<?php
$sql3="SELECT status,count(status) as counter From she_omantel_verify where DATE(date) between '$from' and '$modified_to' and cid='OLIMOB2' group by status";
//exit();
...
<?php
    ...
    <!-- //CODE FOR CR -->
    <?php
    $sql="SELECT  count(distinct msisdn) as counter  FROM `she_omantel_verify`  where DATE(date) between '$from' and '$modified_to' and cid='OLIMOB2'";
    $sql2="SELECT  count(distinct msisdn) as counter  FROM she_omantel_verify  where `status` IN ('PASSED', 'BLOCK') AND DATE(date) between '$from' and '$modified_to' and cid='OLIMOB2'";
...
<br>
<?php
$sql1="SELECT * From she_omantel_verify where date(date) between '$from' and '$modified_to' and cid='OLIMOB2' order by id desc";
//exit();
//exit();
