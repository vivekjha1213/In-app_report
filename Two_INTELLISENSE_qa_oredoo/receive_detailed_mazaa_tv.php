...
$sql3="SELECT status,count(status) as counter two_INTELLISENSE_QA_Oredo__verify where DATE(date) between '$from' and '$to' group by status";
...
<br>
<?php
 $sql1="SELECT * two_INTELLISENSE_QA_Oredo__verify where DATE(date) between '$from' and '$to' order by date desc";
//exit();
//exit();
