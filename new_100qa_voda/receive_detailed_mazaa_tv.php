...
$sql3="SELECT status,count(status) as counter From New_100sec_qa_voda_pin_verify where DATE(date) between '$from' and '$to' group by status";
...
</table>New_100sec_qa_voda_pin_verify
</div>
<br>
<?php
 $sql1="SELECT * From New_100sec_qa_voda_pin_verify where DATE(date) between '$from' and '$to' order by date desc";
//exit();
//exit();
