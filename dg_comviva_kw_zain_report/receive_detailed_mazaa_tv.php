...
$sql3="SELECT status,count(status) as counter From dg_comviva_kw_zain_pin_verify where DATE(date) between '$from' and '$to' group by status";
...
<br>
<?php
 $sql1="SELECT * From dg_comviva_kw_zain_pin_verify where DATE(date) between '$from' and '$to' order by date desc";
//exit();
//exit();
