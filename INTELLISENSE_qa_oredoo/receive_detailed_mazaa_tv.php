<head>
  <title>INTELLISENSE_QA_Oredo__verify PROMOTIONS </title>
  <meta charset="utf-8">
...
$sql3="SELECT status,count(status) as counter From INTELLISENSE_QA_Oredo__verify where DATE(date) between '$from' and '$to' group by status";
...
<br>
<?php
 $sql1="SELECT * From INTELLISENSE_QA_Oredo__verify where DATE(date) between '$from' and '$to' order by date desc";
//exit();
//exit();
