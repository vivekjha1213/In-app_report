...
$sql3="SELECT status,count(status) as counter From atlas_qatar_mobimind_pin_verify where DATE(Date) between '$from' and '$to'  group by status";
...
<br>
<?php
 $sql1="SELECT * From atlas_qatar_mobimind_pin_verify where DATE(Date) between '$from' and '$to'  order by date desc";
//exit();
//exit();
