<head>
  <title>JW_PLS_TWOReport Report PROMOTIONS </title>
  <meta charset="utf-8">
...
$sql3="SELECT status,count(status) as counter From jw_pl_pin_verify where DATE(date) between '$from' and '$to' group by status";
...
<br>
<?php
 $sql1="SELECT * From jw_pl_pin_verify where DATE(date) between '$from' and '$to' order by date desc";
//exit();
//exit();
