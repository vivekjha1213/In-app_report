...
$sql3="SELECT status,count(status) as counter From qatar_mobimind_pin_verify where DATE(Date) between '$from' and '$to' and cid='Mobileart' group by status";
...
<br>
<?php
 $sql1="SELECT * From qatar_mobimind_pin_verify where DATE(Date) between '$from' and '$to' and cid='Mobileart' order by date desc";
//exit();
//exit();
