...
$sql3="SELECT status,count(status) as counter ksa_ENTERTAINMENT_GALAXY_pin_verify where DATE(date) between '$from' and '$to' group by status";
...
<br>
<?php
 $sql1="SELECT * ksa_ENTERTAINMENT_GALAXY_pin_verify where DATE(date) between '$from' and '$to' order by date desc";
//exit();
//exit();
